...
public abstract class TestBaseRapor {
    ...
    public void setUpTest() {
        ...
        extentReports.setSystemInfo("Automation Engineer", "Ebru");
        extentHtmlReporter.config().setDocumentTitle("Rapor");//burada genel olsa da sorun degil cunku
        //extentTest'i atama yaptigimiz class icerisinde bu ismi createTest ile ozellestirebiliyoruz
